            ...
            for buy_order in buy_orders:
                ...
                if sell_price <= buy_price:
                    ...
                    if sell_amount < buy_amount:
                        ...
                        sell_user = DBSession.query(User).filter_by(id=sell_user_id)
                        ...
                        DBSession.query(ActiveOrder).filter_by(id=buy_order_id).update({'amount': buy_order})
                        buy_user = DBSession.query(User).filter_by(id=buy_user_id)
                        DBSession.query(User).filter_by(id=buy_user_id) \
                            .update({'eur': buy_user.eur - (buy_amount - sell_amount) * buy_price,
